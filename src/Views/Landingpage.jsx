          ...
          <table className="border-collapse border border-gray-500 w-full text-center">
            ...
            <tbody>
              {records.map((item, index) => (
                <tr key={index}>
                  <td className="border border-gray-500 p-2">{item.fname}</td>
                  <td className="border border-gray-500 p-2">{item.lname}</td>
                  <td className="border border-gray-500 p-2">{item.gender}</td>
                  <td className="border border-gray-500 p-2">{item.language.join(", ")}</td>
